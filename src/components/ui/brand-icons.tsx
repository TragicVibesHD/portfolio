 ...
 * Brand marks.
 *
 * lucide-react removed brand icons in v1, so GitHub and LinkedIn are
 * inlined here. They are sized with `currentColor` and the same `size-*`
 * utilities as the lucide set so they compose identically.
 */
